...
def insert_user(telegram_id:str, sign_up_time:dt, login_method) -> None:
    """
...
def get_lesson_data_by_key(key_les) -> list[str, int, bool]:
    """
...
def get_user(id:str, query_key:streams="user_id") -> dict[str, object]:
    """
...
def edit_data_point(key_les:str, col:str, value:str, table:str="lessons", key_column="lesson_id") -> None:
    """
...
def get_all_users_in_sport(sport:str) -> list[dict[str, str]]:
    """
